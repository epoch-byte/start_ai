...
- 几个公式
    ...
    * 2.3 
    ...
    $$\frac{\partial(\bf{x}^{T}\bf{A}\bf{x})}{\partial \bf{x}} =$$
    $$ = \frac{\partial ((x_{1}a_{11}+x_{2}a_{21}+...+x_{n}a_{n1}),(x_{1}a_{12}+x_{2}a_{22}+...+x_{n}a_{n2}),...,(x_{1}a_{1n}+x_{2}a_{2n}+...+x_{n}a_{nn}))*(x_{1},x_{2},...,x_{n}))}{\partial \bf{x}} $$
    ...
    $$ = \frac{\partial (x_{1}a_{11}x_{1}+x_{2}a_{21}x_{1}+...+x_{n}a_{n1}x_{1}+x_{1}a_{12}x_{2}+x_{2}a_{22}x_{2}+...+x_{n}a_{n2}x_{2}+...+x_{1}a_{1n}x_{n}+x_{2}a_{2n}x_{n}+...+x_{n}a_{nn}x_{n})}{\partial \bf{x}} $$
    * 2.4
